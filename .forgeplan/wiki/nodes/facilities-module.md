...
- **D-facilities-3-upsert-pattern**: SELECT then INSERT/UPDATE for upsert. Why: SQLite in tests does not support PostgreSQL ON CONFLICT syntax; merge() does SELECT+INSERT which works across both backends. [placementops/modules/facilities/service.py:374]
